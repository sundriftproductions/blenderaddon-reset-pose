...
bl_info = {
    ...
    "description": "This Blender add-on resets the pose for the currently-selected rig." \
                   "To run this, make a Blender keyboard shortcut and use this for the action: wm.reset_pose "\
                   "If you want to call this manually from Python, use this command: bpy.ops.wm.reset_pose()",
    "wiki_url": "https://github.com/sundriftproductions/blenderaddon-reset-pose/wiki",
    "tracker_url": "https://github.com/sundriftproductions/blenderaddon-reset-pose",
    "category": "System"}
